...
% デフォルト高さは15cm
% 空欄時: 解答内容を白色で出力し, 手書き用に数行ぶんの空白を追加
\NewEnviron{problemsolution}[1][15cm]{%
  ...
  \else%
    {\color{white}\BODY}%
    \par\vspace{5\baselineskip}\hfill$\square$%
  \fi%
  \par\vspace{1em}%
}
...
% ========================================
% テクニック環境（緑系：薄い緑背景 + 緑枠）
% 定理と同じ「表示形式・リセット単位」だが, カウンターは独立（theoremとは混ぜない）
% ========================================
\newcounter{technique}
